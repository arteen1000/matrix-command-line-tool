...
You might ask would use this over a graphing calculator. In response, I would say (a) it's much faster to use (b) it's nice to have on your desktop while doing some linear algebra.
...
- you can enter the rows of your matrices, just pressing ***Enter*** at the prompt when done. the program will figure out the dimensions for you
- you are given up to three tries with each prompt to enter valid input
